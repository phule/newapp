						...
						$.each(
							...
							if($.validator.autoCreateRanges){
								if(rules.min&&rules.max){
									...
									delete rules.min;delete rules.max;
								}
				...
				methods:{
					...
					remote:function(value,element,param){
						...
						accept:function(value,element,param){
							param=typeof param=="string"?param.replace(/,/g,'|'):"png|jpe?g|gif";return this.optional(element)||value.match(new RegExp(".("+param+")$","i"));
						},
